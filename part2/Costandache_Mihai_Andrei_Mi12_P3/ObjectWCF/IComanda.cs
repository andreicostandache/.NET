...
namespace ObjectWCF
{
    ...
    interface IComanda
    {
        ...
        [OperationContract]
        Comanda FirstOrDefaultComanda(IDictionary<string, object> criteria = null, string propertiesToInclude = "");
        ...
        [OperationContract]
        IEnumerable<Comanda> GetComenzi(IDictionary<string, object> criteria = null, Func<IQueryable<Comanda>, IOrderedQueryable<Comanda>> ordering = null,
        ...
        [OperationContract]
        int CountComenzi(IDictionary<string, object> criteria = null);
        ...
        [OperationContract]
        bool ContainsComanda(Comanda entity, IEqualityComparer<Comanda> comparer);
        ...
        [OperationContract]
        void AddRangeOfComenzi(IEnumerable<Comanda> entities);
        ...
        [OperationContract]
        void RemoveComanda(Comanda entity);
        ...
        [OperationContract]
        void RemoveRangeOfComenzi(IEnumerable<Comanda> entities);
        ...
        [OperationContract]
        void EditComanda(Comanda entity);

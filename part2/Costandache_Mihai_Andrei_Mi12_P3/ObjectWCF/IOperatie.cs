...
namespace ObjectWCF
{
    ...
    interface IOperatie
    {
        ...
        [OperationContract]
        Operatie FirstOrDefaultOperatie(IDictionary<string, object> criteria = null, string propertiesToInclude = "");
        ...
        [OperationContract]
        IEnumerable<Operatie> GetOperatii(IDictionary<string, object> criteria = null, Func<IQueryable<Operatie>, IOrderedQueryable<Operatie>> ordering = null,
        ...
        [OperationContract]
        int CountOperatii(IDictionary<string, object> criteria = null);
        ...
        [OperationContract]
        bool ContainsOperatie(Operatie entity, IEqualityComparer<Operatie> comparer);
        ...
        [OperationContract]
        void AddRangeOfOperatii(IEnumerable<Operatie> entities);
        ...
        [OperationContract]
        void RemoveOperatie(Operatie entity);
        ...
        [OperationContract]
        void RemoveRangeOfOperatii(IEnumerable<Operatie> entities);
        ...
        [OperationContract]
        void EditOperatie(Operatie entity);
